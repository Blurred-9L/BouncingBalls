...
# Generated by qmake (2.01a) (Qt 4.8.6) on: lun ago 4 10:30:59 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/BouncingBalls1.0.0/ && $(COPY_FILE) --parents Ball.h Bar.h BBController.h BBGame.h BBGraphicsView.h BBSoundPlayer.h BBWidget.h BBWorker.h Brick.h BrickArea.h GameObject.h QtSoundPlayer.h SoundPlayer.h ThreadController.h ThreadWorker.h .tmp/BouncingBalls1.0.0/ && $(COPY_FILE) --parents Ball.cpp Bar.cpp BBController.cpp BBGame.cpp BBGraphicsView.cpp BBSoundPlayer.cpp BBWidget.cpp BBWorker.cpp Brick.cpp BrickArea.cpp GameObject.cpp main.cpp QtSoundPlayer.cpp SoundPlayer.cpp ThreadController.cpp ThreadWorker.cpp .tmp/BouncingBalls1.0.0/ && (cd `dirname .tmp/BouncingBalls1.0.0` && $(TAR) BouncingBalls1.0.0.tar BouncingBalls1.0.0 && $(COMPRESS) BouncingBalls1.0.0.tar) && $(MOVE) `dirname .tmp/BouncingBalls1.0.0`/BouncingBalls1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/BouncingBalls1.0.0
